package com.kelsonthony.costumer.api.exceptionhandler;
...
import com.kelsonthony.costumer.core.validation.ValidationException;
import com.kelsonthony.costumer.domain.exception.EntityInUseException;

import com.kelsonthony.costumer.domain.exception.EntityNotFoundException;
import com.kelsonthony.costumer.domain.exception.BusinessException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private static final String MSG_ERRO_USER_FINAL = "Ocorreu um erro interno inesperado no sistema. "
    ...
    public ResponseEntity<Object> handleUncaught(Exception ex, WebRequest request) {
        ...
        String detail = MSG_ERRO_USER_FINAL;
    ...
    public ResponseEntity<?> handleEntityNotFound(AccessDeniedException ex,
                                                         WebRequest request) {
        ...
        Problem problem = createProblemBuilder(status, problemType, detail)
                .userMessage(detail)
                .userMessage("Você não tem permissão para executar essa operação")
                .build();
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        String detail = "O corpo da requisição eśta inválido. Verifique o erro de sintaxe";
    ...
    private ResponseEntity<Object> handleInvalidFormat(InvalidFormatException ex, HttpHeaders headers,
        ...
        Problem problem = createProblemBuilder(status, problemType, detail)
                .userMessage(MSG_ERRO_USER_FINAL)
                .build();
    ...
    private ResponseEntity<Object> handlePropertyBinding(PropertyBindingException ex, HttpHeaders headers,
        ...
        ProblemType problemType = ProblemType.MENSAGEM_INCOMPREENSIVEL;
        String detail = String.format(
                "A propriedade '%s' não existe. " + "Corrija ou remova esse propriedade e tente novamente.", path);
